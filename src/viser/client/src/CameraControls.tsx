...
export function SynchronizedCameraControls() {
  ...
  React.useEffect(() => {
    ...
    keys.a.addEventListener(holdEvent.HOLD_EVENT_TYPE.HOLDING, (event) => {
      cameraControls.truck(-0.000667 * event?.deltaTime, 0, false);
    });
    ...
    keys.w.addEventListener(holdEvent.HOLD_EVENT_TYPE.HOLDING, (event) => {
      cameraControls.forward(0.000667 * event?.deltaTime, false);
    });
    ...
    keys.q.addEventListener(holdEvent.HOLD_EVENT_TYPE.HOLDING, (event) => {
      cameraControls.elevate(-0.000667 * event?.deltaTime, false);
    });
    ...
    keys.left.addEventListener(holdEvent.HOLD_EVENT_TYPE.HOLDING, (event) => {
      cameraControls.rotate(
        -0.01667 * THREE.MathUtils.DEG2RAD * event?.deltaTime,
        0,
        true,
      );
    });
  ...
  return (
    <>
      <CameraControls
        ...
        dollySpeed={0.333}
        truckSpeed={0.667}
        azimuthRotateSpeed={0.333}
        polarRotateSpeed={0.333}
        onChange={sendCamera}
        onStart={() => {
